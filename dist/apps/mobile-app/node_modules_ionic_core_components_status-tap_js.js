"use strict";
(self["webpackChunkmobile_app"] = self["webpackChunkmobile_app"] || []).push([["node_modules_ionic_core_components_status-tap_js"],{
    ...
    (0,_stencil_core_internal_client__WEBPACK_IMPORTED_MODULE_1__.readTask)(() => {
      ...
      if (contentEl) {
        new Promise(resolve => (0,_helpers_js__WEBPACK_IMPORTED_MODULE_3__.c)(contentEl, resolve)).then(() => {
          (0,_stencil_core_internal_client__WEBPACK_IMPORTED_MODULE_1__.writeTask)(/*#__PURE__*/(0,_home_arazek_workspace_jordi_dance_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
            /**
